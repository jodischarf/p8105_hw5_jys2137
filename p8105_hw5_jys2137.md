...
| Estimate | Statistic | p.value | CI Lower Bound | CI Upper Bound | Method                                               | Alternative |
|---------:|----------:|--------:|---------------:|---------------:|:-----------------------------------------------------|:------------|
|    0.646 |   239.011 |       0 |          0.628 |          0.663 | 1-sample proportions test with continuity correction | two.sided   |
